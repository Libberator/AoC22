...
public class Node<T> : INode<T>
{
    ...
    public Node(int cost = 10) => BaseCost = cost;
    public Node(Vector2Int pos, int cost = 10) : this(cost) => Pos = pos;
    public Node(Vector2Int pos, IGrid<T> grid, int cost = 10) : this(pos, cost) => _grid = grid;
    public Node(T value, Vector2Int pos, int cost = 10) : this(pos, cost) => Value = value;
    public Node(T value, Vector2Int pos, IGrid<T> grid, int cost = 10) : this(pos, grid, cost) => Value = value;
